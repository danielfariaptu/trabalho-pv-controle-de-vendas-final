...
public class AlterarProduto extends javax.swing.JDialog {
 ...
 public void mostrar(){     
        ...
        String uva = produto.getTipoUva();
        JCBoxUva.getModel().setSelectedItem(uva);
        //JCBoxUva.setSelectedItem(uva);
        String vinho = produto.getTipoVinho();
        JCBoxVinho.getModel().setSelectedItem(vinho);
