...
public class AlterarEndereco extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ALTERAÇÃO DE ENDEREÇO");
            ...
            if (!field_Numero.getText().isEmpty()) {
                if (!field_Bairro.getText().isEmpty()) {
                    if (!field_Municipio.getText().isEmpty()) {
                        if (!field_CEP.getText().equals("     -   ")) {
                            if (!jCBoxUf.getItemAt(jCBoxUf.getSelectedIndex()).equals("- Selecione -")) {
                                if (!jCBoxTipoEndereco.getItemAt(jCBoxTipoEndereco.getSelectedIndex()).equals("- Selecione -")) {
                                    ...
                                    JOptionPane.showMessageDialog(rootPane, "Tipo de endereço é obrigatório!");
                        ...
                        JOptionPane.showMessageDialog(rootPane, "Campo Município é obrigatório!");
                ...
                JOptionPane.showMessageDialog(rootPane, "Campo Número é obrigatório!");
    ...
    public void showsCampos() {
        ...
        field_Bairro.setText(end.getBairro());
        field_Municipio.setText(end.getMunicipio());
        field_CEP.setText(String.valueOf(end.getCep()));
 ...
 /*try {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AlterarEndereco dialog = new AlterarEndereco(new javax.swing.JFrame(), true);
